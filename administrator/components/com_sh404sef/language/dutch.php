...
// Dutch translation by Gerard van Enschut
// http://www.joomladownloads.nl | info@joomladownloads.nl
// date: november 2010
//
...
define('COM_SH404SEF_TT_FORCED_HOMEPAGE', 'U kunt hier een gedwongen homepagina URL invullen. Dit is handig wanneer u een flash pagina, vaak een index.html bestand, wilt weergeven wanneer u naar www.mijnsite.nl gaat. Als u dit wilt, typ de volgende URL hier: http://www.mijnsite.nl/index.php (zonder slash /), zoadat de Joomla site wordt weergegeven wanneer u klikt op home in het hoofdmenu.');
...
// V 1.0.12
define('COM_SH404SEF_USE_CAT_ALIAS', 'Gebruik categorie alias');
define('COM_SH404SEF_TT_USE_CAT_ALIAS', 'Indien ingesteld op <strong>Ja</strong>, zal sh404sef gebruik maken van een categorie alias in plaats van de actuele naam iedere keer dat die naam vereist is om een url te bouwen');
define('COM_SH404SEF_USE_SEC_ALIAS', 'Gebruik sectie alias');
define('COM_SH404SEF_TT_USE_SEC_ALIAS', 'Indien ingesteld op <strong>Ja</strong>, zal sh404sef gebruik maken van een sectie alias in plaats van de actuele naam iedere keer dat die naam vereist is om een url te bouwen');
define('COM_SH404SEF_USE_MENU_ALIAS', 'Gebruik menu alias');
define('COM_SH404SEF_TT_USE_MENU_ALIAS', 'Indien ingesteld op <strong>Ja</strong>, zal sh404sef gebruik maken van een menu item alias in plaats van de actuele naam iedere keer dat die naam vereist is om een url te bouwen');
define('COM_SH404SEF_ENABLE_TABLE_LESS', 'Gebruik tabelloze output');
define('COM_SH404SEF_TT_ENABLE_TABLE_LESS', 'Indien ingesteld op <strong>Ja</strong>, zal sh404sef ervoor zorgen dat Joomla alleen div tags (geen tabel tags) gebruikt voor de output van content, ongedacht de template die u gebruikt. U dient de Beez template niet te verwijderen om dit te kunnen gebruiken. De Beez template is standaard ge&iuml;nstelleerd met Joomla.<br /><strong>WAARSCHUWING</strong> : U dient uw template stylesheet af te stemmen om deze overeen te laten komen met het nieuwe html output formaat.');

// V 1.0.13
define( 'COM_SH404SEF_JC_MODULE_CACHING_DISABLED', 'De caching voor Joomfish taal selectie module is uitgezet!');

// V 1.5.3
define('COM_SH404SEF_ALWAYS_APPEND_ITEMS_PER_PAGE', 'Altijd omzetten #items per pagina');
define('COM_SH404SEF_TT_ALWAYS_APPEND_ITEMS_PER_PAGE', 'Indien op <strong>Ja</strong> gezet zal sh404sef altijd het aantal items per pagina omzetten naar leesbare urls. Bijvoorbeeld, .../Page-2.html zal .../Page2-10.html worden, indien de huidige instellingen zijn dat er 10 items per pagina moeten worden getoond. Dit is bijvoorbeeld vereist indien je drop-down lijsten hebt geactiveerd en je bezoeker het aantal items laat kiezen.');

define('COM_SH404SEF_REDIRECT_CORRECT_CASE_URL', '301 redirect url naar juiste case');
define('COM_SH404SEF_TT_REDIRECT_CORRECT_CASE_URL', 'Indien op <strong>Ja</strong> gezet zal sh404sef een 301 redirect maken van van een SEF url indien deze niet dezelfde case heeft als een andere url in de database. Bijvoorbeeld, example.com/My-page.html zal worden geredirect naar example.com/my-page.html, indien de laatste is opgeslagen in de database. Omgekeerd, example.com/my-page.html zal worden geredirect naar example.com/My-page.html indien de url al word gebruikt op de website, en daarom ook al is opgeslagen in de database.');

// V 1.5.5
define('COM_SH404SEF_JOOMLA_LIVE_SITE', 'Joomla live_site');
define('COM_SH404SEF_TT_JOOMLA_LIVE_SITE', 'Hier zie je de root url van je website. Bijvoorbeeld:<br />http://www.example.com<br/>or<br/> http://example.com<br />(geen slash)<br />Dit is geen sh404sef instelling, maar meer een <b>Joomla</b> instelling. Dit staat in het eigen configuration.php bestand van Joomla.<br />Joomla zal normaliter je website root adres automatisch detecteren. Indien het adres zoals hier getoond niet correct is, dien je dat handmatig zelf in te stellen. Dit dient gedaan te worden door de inhoud van het Joomla configuration.php bestand te wijzigen (meestal via FTP).<br/>Symptonen van een slecte waarde zijn : template of afbeeldingen die niet worden getoond, knoppen die niet functioneren, alle stijlen (kleuren, fonts, etc) die niet aanwezig zijn');
define('COM_SH404SEF_TT_JOOMLA_LIVE_SITE_MISSING', 'WAARSCHUWING: $live_site niet aanwezig in het configuration.php bestand van Joomla, of word niet vooraf gegaan van "http://" of "https://" !');
define('COM_SH404SEF_JCL_INSERT_EVENT_ID', 'Toevoegen gebeurtenis Id');
define('COM_SH404SEF_TT_JCL_INSERT_EVENT_ID', 'Indien ingesteld op ja, zal het interne id van de gebeurtenis worden voorgevoegd aan de titel van de gebeurtenis in de urls, zodat zij uniek zijn');
define('COM_SH404SEF_JCL_INSERT_CATEGORY_ID', 'Toevoegen categorie id');
define('COM_SH404SEF_TT_JCL_INSERT_CATEGORY_ID', 'Indien ingesteld op ja, zal iedere gebeurtenis categorie id worden toegevoegd in alle urls van deze gebeurtenis, als aanhangsel van de categorie naam.');
define('COM_SH404SEF_JCL_INSERT_CALENDAR_ID', 'Toevoegen calendar id');
define('COM_SH404SEF_TT_JCL_INSERT_CALENDAR_ID', 'Indien ingesteld op ja, zal het id van de calendar waaraan een gebeurtenis toebehoort, worden toegevoegd aan de calendar naam in alle urls');
define('COM_SH404SEF_JCL_INSERT_CALENDAR_NAME', 'Toevoegen calendar naam');
define('COM_SH404SEF_TT_JCL_INSERT_CALENDAR_NAME', 'Indien ingesteld op ja, zal de naam van de calendar waaraan een gebeurtenis toebehoort, worden toegevoegd aan de calendar naam in alle urls');
define('COM_SH404SEF_JCL_INSERT_DATE', 'Toevoegen datum');
define('COM_SH404SEF_TT_JCL_INSERT_DATE', 'Indien ingesteld op ja, zal de datum van de doelpagina worden toegevoegd in iedere url');
define('COM_SH404SEF_JCL_INSERT_DATE_IN_EVENT_VIEW', 'Toevoegen datum in gebeurtenis link');
define('COM_SH404SEF_TT_JCL_INSERT_DATE_IN_EVENT_VIEW', 'Indien ingesteld op ja, zal iedere gebeurtenis datum worden toegevoegd aan de urls van de gebeurtenis details pagina');
define('COM_SH404SEF_JCL_TITLE', 'JCal Pro configuratie');
define('COM_SH404SEF_PAGE_TITLE_TITLE', 'Pagina titel configuratie');
define('COM_SH404SEF_CONTENT_TITLE_TITLE', 'Joomla content pagina titel configuratie');
define('COM_SH404SEF_CONTENT_TITLE_SHOW_SECTION', 'Toevoegen sectie');
define('COM_SH404SEF_TT_CONTENT_TITLE_SHOW_SECTION', 'Indien ingesteld op ja, zal een artikel sectie worden toegevoegd in de pagina titel van dat artikel');
define('COM_SH404SEF_CONTENT_TITLE_SHOW_CAT', 'Toevoegen categorie');
define('COM_SH404SEF_TT_CONTENT_TITLE_SHOW_CAT', 'Indien ingesteld op ja, zal een artikel categorie worden toegevoegd in de pagina titel van dat artikel');
define('COM_SH404SEF_CONTENT_TITLE_USE_ALIAS', 'Gebruik artikel titel alias');
define('COM_SH404SEF_TT_CONTENT_TITLE_USE_ALIAS', 'Indien ingesteld op ja, zal de artikel alias worden gebruikt in de pagina titel in plaats van de actuele artikel titel');
define('COM_SH404SEF_CONTENT_TITLE_USE_CAT_ALIAS', 'Gebruik categorie alias');
define('COM_SH404SEF_TT_CONTENT_TITLE_USE_CAT_ALIAS', 'Indien ingesteld op ja, zal een categorie alias worden gebruikt in de pagina titel in plaats van de actuele categorie titel');
define('COM_SH404SEF_CONTENT_TITLE_USE_SEC_ALIAS', 'Gebruik sectie alias');
define('COM_SH404SEF_TT_CONTENT_TITLE_USE_SEC_ALIAS', 'Indien ingesteld op ja, zal een sectie alias worden gebruikt in de pagina titel in plaats van de actuele sectie titel');
define('COM_SH404SEF_PAGE_TITLE_SEPARATOR', 'Pagina titel afscheider');
define('COM_SH404SEF_TT_PAGE_TITLE_SEPARATOR', 'Geef hier een karakter of string op om de diverse delen van de pagina titel te scheiden, indien er meer dan 1 is. Standaard word hiervoor het | karakter gebruikt, omgeven door een enkele spatie');

// V 1.5.7
define('COM_SH404SEF_DISPLAY_DUPLICATE_URLS_TITLE', 'Duplicaten');
define('COM_SH404SEF_DISPLAY_DUPLICATE_URLS_NOT', 'Toon alleen hoofd url');
define('COM_SH404SEF_DISPLAY_DUPLICATE_URLS', 'Toon hoofd en duplicaat urls');
define('COM_SH404SEF_INSERT_ARTICLE_ID_TITLE', 'Toeveoegen artikel id in URL');
define('COM_SH404SEF_TT_INSERT_ARTICLE_ID_TITLE', 'Indien ingesteld op <strong>Ja</strong>, zal een intern artikel id worden toegevoegd aan de titel van dat artikel in de URLs, dit om ervoor te zorgen dat ieder artikel afzonderlijk kan worden benaderd, zelfs als 2 artikelen precies dezelfde titel hebben, of titels die dezelfde URL hebben (nadat deze geschoond zijn van niet geldige karakters en dergelijke). Deze id heeft geen SEO waarde, en je kunt beter voorkomen dat je artikelen hebt met dezelfde titel in dezelfde sectie en categorie.<br />In het geval dat je geen controle hebt over het toevoegen van artikelen, kan deze instelling helpen dat dergelijke artikelen wel zijn te benaderen, met als doel een goede zoek machine optimalisatie.');

// V 1.5.8

define('COM_SH404SEF_JS_TITLE', 'JomSocial configuratie ');
define('COM_SH404SEF_JS_INSERT_NAME', 'Toevoegen Jomsocial naam');
define('COM_SH404SEF_TT_JS_INSERT_NAME', 'Indien ingesteld op <strong>Ja</strong>, zal de menu element titel, welke leid naar de JomSocial hoofd pagina, worden toegevoegd aan alle JomSocial SEF URLs');
define('COM_SH404SEF_JS_INSERT_USER_NAME', 'Toevoegen korte gebruikersnaam');
define('COM_SH404SEF_TT_JS_INSERT_USER_NAME', 'Indien ingesteld op <strong>Ja</strong>, zal de verkorte gebruikersnaam worden toegevoegd aan de SEF URLs. <strong>WAARSCHUWING</strong>: dit kan leiden tot een aanzienlijke groei van de grootte van de database en kan daardoor je website vertragen als je veel geregistreerde gebruikers hebt.');
define('COM_SH404SEF_JS_INSERT_USER_FULL_NAME', 'Toevoegen volledige gebruikersnaam');
define('COM_SH404SEF_TT_JS_INSERT_USER_FULL_NAME', 'Indien ingesteld op <strong>Ja</strong>, zal de volledige gebruikersnaam worden toegevoegd aan de SEF URLs. <strong>WAARSCHUWING</strong>: dit kan leiden tot een aanzienlijke groei van de grootte van de database en kan daardoor je website vertragen als je veel geregistreerde gebruikers hebt.');
define('COM_SH404SEF_JS_INSERT_GROUP_CATEGORY', 'Toevoegen groep categorie');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_CATEGORY', 'Indien ingesteld op <strong>Ja</strong>, zal een gebruikersgroep categorie worden toegevoegd aan de SEF URLs waar de groep naam word gebruikt.');
define('COM_SH404SEF_JS_INSERT_GROUP_CATEGORY_ID', 'Toevoegen groep categorie ID');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_CATEGORY_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een gebruikersgroep categorie ID worden toegevoegd aan de categorie naam <strong>wanneer de voorgaande optie eveneens is aangezet</strong>, voor het geval dat 2 categori&euml;n dezelfde naam hebben.');
define('COM_SH404SEF_JS_INSERT_GROUP_ID', 'Toevoegen groep ID');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een gebruikersgroep ID worden toegevoegd aan de groep naam, voor het geval dat 2 groepen dezelfde naam hebben.');
define('COM_SH404SEF_JS_INSERT_GROUP_BULLETIN_ID', 'Toevoegen groep bulletin ID');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_BULLETIN_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een gebruikersgroep bulletin ID worden toegevoegd aan de bulletin naam, voor het geval dat 2 bulletins dezelfde naam hebben.');
define('COM_SH404SEF_JS_INSERT_DISCUSSION_ID', 'Toevoegen groep discussie ID');
define('COM_SH404SEF_TT_JS_INSERT_DISCUSSION_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een gebruikersgroep discussie ID worden toegevoegd aan de discussie naam, voor het geval dat 2 discussies dezelfde naam hebben.');
define('COM_SH404SEF_JS_INSERT_MESSAGE_ID', 'Toevoegen boodschap ID');
define('COM_SH404SEF_TT_JS_INSERT_MESSAGE_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een boodschap ID worden toegevoegd aan de boodschap naam, voor het geval dat 2 boodschappen hezelfde onderwerp hebben.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ALBUM', 'Toevoegen foto album naam');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ALBUM', 'Indien ingesteld op <strong>Ja</strong>, zal de naam van het album waaraan deze toebehoort worden toegevoegd aan de SEF URLs van een foto of een set van foto\'s.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ALBUM_ID', 'Toevoegen foto album ID');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ALBUM_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een album ID worden toegevoegd aan de naam van het album, voor het geval dat 2 albums hezelfde onderwerp hebben.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ID', 'Toevoegen foto ID');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een foto ID worden toegevoegd aan de naam van de foto, voor het geval dat 2 foto\'s hezelfde onderwerp hebben.');
define('COM_SH404SEF_JS_INSERT_VIDEO_CAT', 'Toevoegen video categorie naam');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_CAT', 'Indien ingesteld op <strong>Ja</strong>, zal de naam van de categorie waaraan deze toebehoort worden toegevoegd aan de SEF URLs van een video of een set van video\'s.');
define('COM_SH404SEF_JS_INSERT_VIDEO_CAT_ID', 'Toevoegen video categorie ID');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_CAT_ID', 'Indien ingesteld op <strong>Ja</strong>, zal de video categorie ID worden toegevoegd aan de categorie naam, voor het geval dat 2 categori&euml;n hezelfde onderwerp hebben.');
define('COM_SH404SEF_JS_INSERT_VIDEO_ID', 'Toevoegen video ID');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_ID', 'Indien ingesteld op <strong>Ja</strong>, zal een video ID worden toegevoegd aan de video naam, voor het geval dat 2 video\'s hezelfde onderwerp hebben.');
define('COM_SH404SEF_FB_INSERT_USERNAME', 'Toevoegen gebruikersnaam');
define('COM_SH404SEF_TT_FB_INSERT_USERNAME', 'Indien ingesteld op <strong>Ja</strong>, zal de gebruikersnaam worden toegevoegd aan de SEF URLs voor haar berichten of profiel.');
define('COM_SH404SEF_FB_INSERT_USER_ID', 'Toevoegen gebruiker ID');
define('COM_SH404SEF_TT_FB_INSERT_USER_ID', 'Indien ingesteld op <strong>Ja</strong>, Een gebruiker ID zal worden toegevoegd aan haar naam, indien de voorgaande instelling op ja staat, voor het geval dat 2 gebruikers dezelfde gebruikersnaam hebben.');
define('COM_SH404SEF_PAGE_NOT_FOUND_ITEMID', 'Itemid om te gebruiken voor de 404 pagina');
define('COM_SH404SEF_TT_PAGE_NOT_FOUND_ITEMID', 'De waarde die hier word ingevuld, indien deze niet nul is, zal worden gebruikt om de 404 pagina te tonen. Joomla zal het Itemid gebruiken om te bepalen welke template en modules worden getoond. Itemid representeren een menu item, zodat je deze Itemids kunt terugvinden in je menu lijst.');
