<?php
/**
 * @version		$Id: pagination.php 2109 2011-10-24 10:01:24Z silianacom-svn $
...
class JPagination extends JObject
{
  ...
  function getPagesLinks()
  {
    ...
    if ($data->start->base !== null) {
      ...
      // is this prev?
      $options = array();
      if($data->previous->base !== null && (empty($data->previous->base) || $data->previous->base == $data->start->base)) {
        $options['rel'] = 'prev';
      }
  ...
  function _item_active(&$item, $options = array())
  {
    global $mainframe;
    if ($mainframe->isAdmin())
    {
