 ...
 * @version     $Id: default_topsocialplusonepage.php 2156 2011-11-18 17:50:43Z silianacom-svn $
 */
...
<fieldset>
  ...
  <?php if (!empty($this->analytics->analyticsData->topSocialPlusOnePage)) : ?>
   ...
   <legend><?php echo JText16::_('COM_SH404SEF_ANALYTICS_SOCIAL_PLUS_ONE_PAGE_ENGAGEMENT'); ?></legend>
    ...
    <thead>
      <tr>
        ...
        <?php  $t = JText16::_('COM_SH404SEF_ANALYTICS_TOTAL_PLUSONE_PAGE_ENGAGEMENT') . '::' . JText16::_('COM_SH404SEF_ANALYTICS_TOTAL_PLUSONE_PAGE_ENGAGEMENT_DESC'); ?>
        <th class="title hasAnalyticsTip" title="<?php echo $t;?>" >
        <?php echo JText16::_( 'COM_SH404SEF_ANALYTICS_TOTAL_PLUSONE_PAGE_ENGAGEMENT' ); ?>
        </th>
 	...
 	<?php else : ?>
 	  <legend><?php echo JText16::_('COM_SH404SEF_ANALYTICS_SOCIAL_NO_PLUS_ONE_PAGE_ENGAGEMENT'); ?></legend>
 	<?php endif; ?>
