...
?>
			...
			<div class="fwg-vote-box">
				<span title="<?php echo JText :: _('FWG_RATING_VALUE_AND_RATING_COUNT'); ?>">(<?php echo round($this->row->_rating_value, 2); ?>/<?php echo (int)$this->row->_rating_count; ?>)</span> <?php echo JText :: _($this->row->_rating_count!=1?'Votes':'Vote'); ?>
			</div>
	        <div class="clr"></div>
